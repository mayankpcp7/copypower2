            ...
            <div className='relative'>
                ...
                <div className='py-12 md:py-[60px] lg:py-20 xl:py-[150px] relative z-[10]'>
                    <div className='max-w-[1140px] mx-auto px-3'>
                        <h2 className='text-[40px] font-Matter font-semibold leading-[135%] tracking-[-0.8px] text-main text-center pb-0.5'>Recent Articles</h2>
                        ...
                        <div className=' py-5 sm:py-12 md:py-16 flex flex-wrap justify-center items-center gap-10'>
                            ...
                            <div className='max-w-[345px] w-full rounded-[15px] bg-white card_shadow overflow-hidden cursor-pointer'>
                                ...
                                <h3 className='font-Matter text-[24px] font-semibold leading-[145%] max-w-[270px] mx-10 mt-10 pb-5'>A comprehensive guide to email marketing automation.</h3>
                            ...
                            <div className='max-w-[345px] w-full rounded-[15px] bg-white card_shadow overflow-hidden cursor-pointer'>
                                ...
                                <h3 className='font-Matter text-[24px] font-semibold leading-[145%] max-w-[270px] mx-10 mt-10 pb-5'>Everything you need to know about Google E-E-A-T guidelines</h3>
                            ...
                            <div className='max-w-[345px] w-full rounded-[15px] bg-white card_shadow overflow-hidden cursor-pointer'>
                                ...
                                <p className='font-Matter text-[24px] font-semibold leading-[145%] max-w-[270px] mx-10 mt-10 pb-5'>Which marketing automation platform is right for you? </p>
                        ...
                        <div className='flex items-center justify-center mt-3 pt-0.5'>
                            <button className='text-[18px] font-semibold font-Matter leading-[120%] text-secondblack border-solid border border-secondblack py-5 px-7 h-[62px] w-[176px] rounded-lg hover:bg-secondblack hover:text-white transition-all duration-300'>More Articles</button>
                        </div>
