...
const ArticleSec = () => {
    return (
        <div className="mx-auto max-w-[1920px]">
          ...
          width={1315}
          height={800}
          className="absolute top-[-5%] sm:top-[-10%] md:top-[-14%] lg:top-[-20%] start-[-18%] md:start-[-15%]"
        ...
        <Image
          height={563}
          width={880}
          className="absolute top-[0%] sm:top-[-18%] md:top-[-20%] lg:top-[-20%] end-[-10%]"
          src="/images/webp/ellipse_61.webp"
              ></Image>
              
        <Image width={996} height={950}
          className="absolute top-[0%] start-0"
          src="/images/webp/ellipse_59.webp"
              ></Image>
              
        <Image
          height={435}
          width={582}
          className="absolute top-[25%] sm:top-[15%] md:top-[37%] start-[-25%] md:start-[-10%]"
          src="/images/webp/ellipse_57.webp"
              ></Image>
              
        <Image
          height={759}
          width={664}
          className="absolute top-[35%] md:top-[10%] end-[-15%]"
          src="/images/webp/ellipse_58.webp"
        ></Image>
              ...
              <div className="max-w-[1140px] mx-auto px-3">
                ...
                <div className=" py-5 sm:py-12 md:py-16 flex flex-wrap justify-center items-center gap-10">
                  ...
                  <div className="max-w-[345px] w-full rounded-[15px] bg-white card_shadow overflow-hidden cursor-pointer">
                    ...
                    <h3 className="font-Matter text-[20px] sm:text-[22px] md:text-[24px] font-semibold leading-[145%] max-w-[270px] mx-10 mt-10 pb-5">
                      Everything you need to know about Google E-E-A-T
                      guidelines
                    </h3>
