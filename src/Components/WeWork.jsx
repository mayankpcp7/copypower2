...
const WeWork = () => {
  ...
  return (
    <>
      <div>
        <section className="pt-[44px] bg-work">
          <div ref={triggerRef}>
            <div ref={sectionRef} className="container ">
              ...
              <div className="flex content-wrapper justify-center flex-wrap items-center md:justify-between mt-[66px] h-screen overflow-x-hidden">
                {work.map((process) => {
                  return (
                    <>
                      <div
                        className="md:w-6/12 w-10/12 px-3 mb-[50px]  md:mb-[100px] xl:mb-[140px]"
                        key={process.id}
                      >
                        <Image
                          src={process.img}
                      ...
                      <div
                        className="md:w-5/12 w-10/12 px-3 md:mb-[100px] mb-[70px] xl:mb-[140px]"
                        key={process.id}
                      >
