    ...
    return (
        <div className='max-w-[1920px] mx-auto'>
            <div className='relative'>
                ...
                <Image className='absolute lg:bottom-[-100%] xl:bottom-[-60%] start-[0%]' src={ellipse_68}></Image>
                <div className='pb-12 md:pb-[60px] lg:pb-20 xl:pb-[150px] mx-auto max-w-[1140px] px-3 relative z-[50]'>
                    <div className='max-w-[650px] lg:max-w-[1140px] mx-auto !w-full border-white rounded-[22px] bg-white overflow-hidden'>
